...
const validCpfs = ['317.153.361-86', '198.454.187-08', '147.085.437-60'];
...
const cpfsWithSameDigit = ['111.111.111-11', '222.222.222-22', '333.333.333-33'];

test.each(cpfsWithSameDigit)(
